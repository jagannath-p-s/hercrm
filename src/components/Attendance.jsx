...
const Attendance = () => {
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4 mr-4 mt-2 ml-4">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-4 mr-4 mt-2 ml-4">
        <Card>
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-center mb-4 mr-4 mt-2 ml-4">
            ...
            <div className="flex items-center space-x-4 mb-4 mr-4 mt-2 ml-4">
